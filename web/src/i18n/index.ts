...
const messages = {
  en: {
    ...
    serversPage: {
      ...
      agentBundleDownloaded: "Agent deployment bundle downloaded",
      agentDeployFailed: "Failed to prepare agent deployment bundle",
      nomad: "Nomad",
      distro: "Distro",
      ufw: "UFW",
      ufwActive: "Active",
  ...
  "zh-CN": {
    ...
    serversPage: {
      ...
      agentBundleDownloaded: "Agent 部署包已下载",
      agentDeployFailed: "无法准备 Agent 部署包",
      nomad: "Nomad",
      distro: "发行版",
      ufw: "UFW",
      ufwActive: "已启用",
