...
export const mockSelfSigned = [
  { id: 'self-ca-local', kind: 'ca', name: 'Local development CA', commonName: 'Seamark Local CA', dnsNames: [], ipAddresses: [], fingerprint: 'SHA256:CA11', notBefore: '2026-01-01T00:00:00.000Z', notAfter: '2031-01-01T00:00:00.000Z', createdAt: '2026-01-01T00:00:00.000Z', updatedAt: now },
