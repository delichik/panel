...
export const mockApplications: ApplicationDto[] = [
  {
    ...
    reverseProxy: [{ domain: 'shop.example.test', targetPort: 8080, originServerIds: ['srv-edge-sgp', 'srv-api-hkg'], anyAccess: { enabled: true, strategy: 'round_robin' }, paths: [{ path: '/', webSocket: false }] }],
    generation: 7,
  ...
  },
  {
    ...
    reverseProxy: [{ domain: 'api.example.test', targetPort: 9000, originServerIds: ['srv-api-hkg', 'srv-api-hkg-02'], anyAccess: { enabled: true, strategy: 'least_conn' }, paths: [{ path: '/v1', webSocket: false }, { path: '/events', webSocket: true }] }],
    generation: 12,
  ...
  },
  {
    ...
    reverseProxy: [{ domain: 'docs.example.test', targetPort: 8080, originServerIds: ['srv-observability-ams'], anyAccess: { enabled: false }, paths: [{ path: '/', webSocket: false }] }],
    generation: 4,
    specHash: 'hash-docs',
  ...
  },
  {
    ...
    reverseProxy: [{ domain: 'billing.example.test', targetPort: 8088, originServerIds: ['srv-api-hkg', 'srv-edge-sgp'], anyAccess: { enabled: true, strategy: 'least_conn' }, paths: [{ path: '/', webSocket: false }, { path: '/webhooks', webSocket: false }] }],
    generation: 9,
  ...
  },
  {
    ...
    reverseProxy: [{ domain: 'hooks.example.test', targetPort: 8091, originServerIds: ['srv-edge-sgp', 'srv-edge-lax'], anyAccess: { enabled: true, strategy: 'round_robin' }, paths: [{ path: '/v1/hooks', webSocket: false }] }],
    generation: 4,
  ...
  },
  {
    ...
    reverseProxy: [{ domain: 'checkout-canary.example.test', targetPort: 8080, originServerIds: ['srv-api-hkg-02'], anyAccess: { enabled: false }, paths: [{ path: '/', webSocket: false }] }],
    generation: 11,
