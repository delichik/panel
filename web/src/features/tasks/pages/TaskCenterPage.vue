...
async function loadTasks() {
  loading.value = true;
  try {
    const [taskRows, serverRows] = await Promise.all([
      tasksApi.list({
...
<template>
  <div>
    <div class="panel-header panel">
      ...
      <div class="toolbar">
        <el-select v-model="serverFilter" class="filter server-filter" placeholder="Server" clearable @change="loadTasks">
        ...
        <el-select v-model="statusFilter" class="filter" placeholder="Status" @change="loadTasks">
