...
var (
	...
	codeTranslations = map[string]map[string]string{
		LocaleSimplifiedChinese: {
			...
			"invalid_nomad_namespace":                       "Nomad namespace 不能为空",
			"invalid_nomad_region":                          "Nomad region 不能为空",
			"invalid_nomad_datacenter":                      "Nomad datacenter 不能为空",
			...
			"nomad_redeploy_executor_unavailable":           "Nomad 重部署执行器不可用",
			"nomad_redeploy_server_required":                "必须提供服务器 ID",
			"nomad_redeploy_role_required":                  "重部署时必须提供 Nomad 节点角色",
			...
			"nomad_advertise_address_invalid":               "请选择有效的 Nomad advertise 地址",
			"nomad_advertise_address_not_detected":          "所选 Nomad 地址必须匹配服务器探测到的网卡 IP 或 SSH host IP",
			"nomad_advertise_address_migration_required":    "请先选择明确的 Nomad advertise 地址并重建集群",
	...
	exactTranslations = map[string]map[string]string{
		LocaleSimplifiedChinese: {
			...
			"Nomad namespace is required":                                                   "Nomad namespace 不能为空",
			"Nomad region is required":                                                      "Nomad region 不能为空",
			"Nomad datacenter is required":                                                  "Nomad datacenter 不能为空",
