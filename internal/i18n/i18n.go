...
var (
	...
	codeTranslations = map[string]map[string]string{
		LocaleSimplifiedChinese: {
			...
			"nomad_advertise_address_invalid":               "请选择服务器网卡上的有效 Nomad 地址",
			"nomad_advertise_address_not_detected":          "所选 Nomad 地址未在服务器探测到的网卡中找到",
			"nomad_advertise_address_migration_required":    "请先选择明确的 Nomad 网络地址并重建集群",
