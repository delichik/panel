...
- Nomad Jobs 页面：`web/src/features/nomad/pages/NomadJobsPage.vue`
- Nomad deployments / evaluations / services 页面：`web/src/features/deployments/pages/DeploymentsPage.vue`
